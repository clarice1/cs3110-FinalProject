...
(* $Id: graphic_image.ml,v 1.12 2004/09/07 07:31:04 weis Exp $ *)
...
let array_of_image img =
  ...
  | Index8 bitmap ->
    ...
    and colormap = bitmap.Index8.colormap.map
    in
  ...
  | Index16 bitmap ->
    ...
    and colormap = bitmap.Index16.colormap.map
    in
    let cmap = Array.map (fun {r = r; g = g; b = b} -> rgb r g b) colormap in
